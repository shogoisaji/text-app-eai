...
import { LottieIcon } from "../component/lottieIcon";
  ...
  return (
    <div>
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        <h1
          className={`z-10 text-3xl text-center font-bold ${
        ...
        <div
          className={`z-10 bg-white p-4 my-8 rounded-lg shadow-2xl ${
